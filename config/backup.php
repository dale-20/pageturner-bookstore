...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'pageturner-backup'),
         ...
         */
        'temporary_directory' => storage_path('app/pageturner-backup'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'laureto.christiandale22@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'laureto.christiandale22@gmail.com'),
